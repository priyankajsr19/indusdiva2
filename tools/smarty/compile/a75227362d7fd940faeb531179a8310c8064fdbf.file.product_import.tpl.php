<?php /* Smarty version Smarty-3.0.7, created on 2015-08-21 15:53:48
         compiled from "/var/www/indusdiva.com/themes/violettheme/admin/product_import.tpl" */ ?>
<?php /*%%SmartyHeaderCode:190113108555d6fc34745308-03666999%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a75227362d7fd940faeb531179a8310c8064fdbf' => 
    array (
      0 => '/var/www/indusdiva.com/themes/violettheme/admin/product_import.tpl',
      1 => 1440148864,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '190113108555d6fc34745308-03666999',
  'function' => 
  array (
  ),
...
" method="post" id="productImport" style="display:width:520px;margin-left:200px">
	...
	<div style="margin:20 auto;">
		<fieldset style="margin-bottom:10px;">
			<legend><img src="../img/admin/tab-tools.gif" />Set B1G1/B2G3 Tag</legend>
			<form enctype="multipart/form-data" action="<?php echo $_smarty_tpl->getVariable('currentIndex')->value;?>
&token=<?php echo $_smarty_tpl->getVariable('token')->value;?>
" method="post" id="productImport" style="display:width:520px;margin-left:200px">
		...
		<fieldset style="margin-bottom:10px;">
			<legend><img src="../img/admin/tab-tools.gif" />Delete B1G1/B2G3 Tag</legend>
			<form enctype="multipart/form-data" action="<?php echo $_smarty_tpl->getVariable('currentIndex')->value;?>
&token=<?php echo $_smarty_tpl->getVariable('token')->value;?>
" method="post" id="productImport" style="display:width:520px;margin-left:200px">
				...
				Select Products Tags file: <input name="b1g1_tag_file" type="file" /><br />
                                <input type="submit" value="Upload" />
				<input type="submit" value="Delete Tags" />
			</form>
		</fieldset>
	</div>

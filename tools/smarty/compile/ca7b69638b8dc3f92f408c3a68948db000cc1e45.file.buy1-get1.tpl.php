<?php /* Smarty version Smarty-3.0.7, created on 2015-08-07 12:43:16
         compiled from "C:\xampp\htdocs\indusdiva2/themes/violettheme/buy1-get1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2506255c45a8cb95fc1-52625030%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca7b69638b8dc3f92f408c3a68948db000cc1e45' => 
    array (
      0 => 'C:\\xampp\\htdocs\\indusdiva2/themes/violettheme/buy1-get1.tpl',
      1 => 1434543381,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2506255c45a8cb95fc1-52625030',
  'function' => 
  array (
  ),
...
?>
			<li class="ajax_block_product b1" style=" margin-left:15px; min-height:315px; overflow:hidden">
...
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['product']->key => $_smarty_tpl->tpl_vars['product']->value){
?>
     <li class="ajax_block_product b2" style=" margin-left:15px; min-height:315px; overflow:hidden">
        <?php $_smarty_tpl->tpl_vars['productitem'] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value, null, null);?>
        <?php $_smarty_tpl->tpl_vars['product'] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value, null, null);?>
        <?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('tpl_dir')->value)."./product_card_small.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>

<?php /* Smarty version Smarty-3.0.7, created on 2015-08-14 12:46:34
         compiled from "C:\xampp\htdocs\indusdiva2/themes/violettheme/admin/mailer.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3226155cd95d2cf6671-20655551%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97e4122f2dab999d1994cc82c90bb1df5025460a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\indusdiva2/themes/violettheme/admin/mailer.tpl',
      1 => 1438950032,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3226155cd95d2cf6671-20655551',
  'function' => 
  array (
  ),
...
" name="action_link" />
            ...
            <p>
                ...
                <select name="template">
                    ...
                    <?php }?>
                    <?php if ($_smarty_tpl->getVariable('template')->value=='regionn.tpl'){?>
                        <option value='regionn.tpl' selected>Region</option>
                    <?php }else{ ?>
                        <option value='regionn.tpl'>Region</option>
                    <?php }?>
                    ...
                    <?php }?>
                     <?php if ($_smarty_tpl->getVariable('template')->value=='fullPageMailer.tpl'){?>
                        <option value='fullPageMailer.tpl' selected>Full Page Mailer</option>
                    <?php }else{ ?>
                        <option value='fullPageMailer.tpl'>Full Page Mailer</option>
                    <?php }?>
                </select>
            </p>
        </fieldset>

<?php /* Smarty version Smarty-3.0.7, created on 2014-12-23 17:38:48
         compiled from "/var/www/indusdiva.com/themes/violettheme/order-feedback.tpl" */ ?>
<?php /*%%SmartyHeaderCode:92256075654995b50478e27-90020736%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '412cd60bae78b17d8b26bd61b850ea7788447077' => 
    array (
      0 => '/var/www/indusdiva.com/themes/violettheme/order-feedback.tpl',
      1 => 1371901138,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92256075654995b50478e27-90020736',
  'function' => 
  array (
  ),
...
<div style="width:980px;">
	...
	<?php }else{ ?>
	<form id="address_form" action="<?php echo $_smarty_tpl->getVariable('link')->value->getPageLink('order-feedback.php',true);?>
" method="post" class="" style="margin:auto;width:600px;border: 1px solid #D0D3D8;box-shadow: 0 1px 3px 0 black;padding:10px">
		...
		<p class="submit2" style="padding:0">
                        <input type="hidden" name="oid" value="<?php echo $_smarty_tpl->getVariable('id_order')->value;?>
" />

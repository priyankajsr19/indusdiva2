<?php /* Smarty version Smarty-3.0.7, created on 2015-10-07 13:42:38
         compiled from "C:\xampp\htdocs\indusdiva2/themes/violettheme/modules/blockuserinfo/blockuserinfo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:181595614d3f6c6a497-43900933%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eafa0d4f3e4f2c6c31a5a55f2482a8f9f0e980e8' => 
    array (
      0 => 'C:\\xampp\\htdocs\\indusdiva2/themes/violettheme/modules/blockuserinfo/blockuserinfo.tpl',
      1 => 1444166048,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '181595614d3f6c6a497-43900933',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_replace')) include 'C:\xampp\htdocs\indusdiva2\tools\smarty\plugins\modifier.replace.php';
...
" >
				<div style="width:80px" class="clearfix">
					<div class="sbagtxt">
						MY BAG <?php if ($_smarty_tpl->getVariable('cart_qties')->value>0){?>(<?php echo $_smarty_tpl->getVariable('cart_qties')->value;?>
)<?php }?>
					</div>
...
" >
				<div style="width:80px" class="clearfix">
					<div class="sbagtxt">
						WISH LIST <?php if ($_smarty_tpl->getVariable('cart_qties')->value>0){?>(<?php echo $_smarty_tpl->getVariable('cart_qties')->value;?>
)<?php }?>
					</div>
...
" >
				<div style="width:80px" class="clearfix">
					<div class="sbagtxt">
						INR <?php if ($_smarty_tpl->getVariable('cart_qties')->value>0){?>(<?php echo $_smarty_tpl->getVariable('cart_qties')->value;?>
)<?php }?>
					</div>
...
" >
				<div style="width:80px" class="clearfix">
					<div class="sbagtxt">
						MY ACCOUNT <?php if ($_smarty_tpl->getVariable('cart_qties')->value>0){?>(<?php echo $_smarty_tpl->getVariable('cart_qties')->value;?>
)<?php }?>
					</div>
...
" >
				<div style="width:80px" class="clearfix">
					<div class="sbagtxt">
						CONTACT US <?php if ($_smarty_tpl->getVariable('cart_qties')->value>0){?>(<?php echo $_smarty_tpl->getVariable('cart_qties')->value;?>
)<?php }?>
					</div>

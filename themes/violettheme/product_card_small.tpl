<div class=" product_card">
    ...
    <a href="{$productitem.product_link}">
        <span class="product_image_medium" href="{$productitem.product_link}" title="{$productitem.name|escape:html:'UTF-8'}">  {if (!empty($productitem.tags) && in_array("buy1get1", $productitem.tags))}
